...
public class RRHC_WriteResult {
	
	public static void writeResult (double [][] result, String modelName, long time, int restart)
	{
		...
		String filepath = "D:\\Java Output\\Moorefield\\Simultaneous Modelling Project 1\\Random Restart HC\\RRHC_Result_"+restart+"_"+modelName+".txt";
	...
	public static void writeBundles (ArrayList<ArrayList<Integer>> curCluster, int restart, String modelName)
	{
		...
		String filepath = "D:\\Java Output\\Moorefield\\Simultaneous Modelling Project 1\\Random Restart HC\\RRHC_Bundles_"+restart+"_"+modelName+".txt";
	...
	public static void writetime (double time, String modelName)
	{
				//String filepath = "C:\\Zairul Mazwan\\Java Output\\Moorefield\\Simultaneous_Modeling_Project1\\Hill Climbing\\HC_Bundles.txt";
				
				String filepath = "D:\\Java Output\\Moorefield\\Simultaneous Modelling Project 1\\Random Restart HC\\RRHC_runningtime_"+modelName+".txt";
